...
function(AddTarget)
  ...
  # test
  if(ARG_TEST AND NOT "${BuildTest_${PROJECT_NAME}}")
    return()
  endif()
  ...
  _ExpandSources(sources_public ARG_SOURCE_PUBLIC)
  _ExpandSources(sources_interface ARG_SOURCE_INTERFACE)
  _ExpandSources(sources_private ARG_SOURCE)
  ...
  GetTargetName(coreTargetName ${CMAKE_CURRENT_SOURCE_DIR})
  ...
  Print_List(STRS ${sources_private}
    TITLE  "- sources (private):"
    PREFIX "  * ")
  Print_List(STRS ${sources_interface}
    TITLE  "- sources interface:"
    PREFIX "  * ")
  Print_List(STRS ${sources_public}
    TITLE  "- sources public:"
    PREFIX "  * ")
  Print_List(STRS ${ARG_DEFINE}
    TITLE  "- define (public):"
    PREFIX "  * ")
  Print_List(STRS ${ARG_DEFINE_PRIVATE}
    TITLE  "- define interface:"
    PREFIX "  * ")
  Print_List(STRS ${ARG_DEFINE_INTERFACE}
    TITLE  "- define private:"
    PREFIX "  * ")
  Print_List(STRS ${ARG_LIB}
    TITLE  "- lib (public):"
    PREFIX "  * ")
  Print_List(STRS ${ARG_LIB_INTERFACE}
    TITLE  "- lib interface:"
    PREFIX "  * ")
  Print_List(STRS ${ARG_LIB_PRIVATE}
    TITLE  "- lib private:"
    PREFIX "  * ")
  Print_List(STRS ${ARG_INC}
    TITLE  "- inc (public):"
    PREFIX "  * ")
  Print_List(STRS ${ARG_INC_INTERFACE}
    TITLE  "- inc interface:"
    PREFIX "  * ")
  Print_List(STRS ${ARG_INC_PRIVATE}
    TITLE  "- inc private:"
    PREFIX "  * ")
  Print_List(STRS ${ARG_DEFINE}
    TITLE  "- define (public):"
  ...
  Print_List(STRS ${ARG_DEFINE_PRIVATE}
    TITLE  "- define private:"
    PREFIX "  * ")
  Print_List(STRS ${ARG_C_OPTION}
    TITLE  "- compile option (public):"
    PREFIX "  * ")
  Print_List(STRS ${ARG_C_OPTION_INTERFACE}
    TITLE  "- compile option interface:"
    PREFIX "  * ")
  Print_List(STRS ${ARG_C_OPTION_PRIVATE}
    TITLE  "- compile option private:"
    PREFIX "  * ")
  Print_List(STRS ${ARG_L_OPTION}
    TITLE  "- link option (public):"
    PREFIX "  * ")
  Print_List(STRS ${ARG_L_OPTION_INTERFACE}
    TITLE  "- link option interface:"
    PREFIX "  * ")
  Print_List(STRS ${ARG_L_OPTION_PRIVATE}
  ...
  if("${ARG_MODE}" STREQUAL "EXE")
    ...
    if(MSVC)
      set_target_properties(${coreTargetName} PROPERTIES VS_DEBUGGER_WORKING_DIRECTORY "${RootProjectPath}/bin")
    endif()
